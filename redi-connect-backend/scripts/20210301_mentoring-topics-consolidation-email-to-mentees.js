...
 
<mj-text mj-class="text" padding="0 0 20px 0">Are you ReDI? During our onboarding conversations with you, we felt that we need to adapt the mentoring topics you can choose from. We want to be able to better reflect your needs and interests. So here you go!</mj-text>
...
 
<mj-text mj-class="text" padding="0 0 20px 0">So, what changed?</mj-text>
<mj-text mj-class="text" padding="0 0 10px 0">👉 We added a few more categories to better group the different mentoring fields, i.e. you will now see the categories: Software Engineering, Career Support, 🆕 Design, 🆕 Other Professions, 🆕 Language and 🆕 Other.</mj-text>
<mj-text mj-class="text" padding="0 0 10px 0">👉 We created more topics so that you can be more specific about the support you are seeking, esp. under the category Career Support. We also added non-tech job profiles, in case you are also interested to work in such a field and would like to meet someone working there.</mj-text>
<mj-text mj-class="text" padding="0 0 10px 0">👉 A few old topics were dropped since not many people selected them. Other topics we split up into separate ones, e.g. Mobile Development, Web Development and Graphics & UX/UI (Berlin users only). Whenever this was the case, we selected all new options for you. So please have a look and make sure which topics you would like to keep checked or whether you want to change the selected topics.</mj-text>
<mj-text mj-class="text" padding="0 0 10px 0">👉 Since overall, we added more topics, you will now be able to select up to four (previously three) mentoring topics you're looking for support in.</mj-text>
 
<mj-text mj-class="text" padding="0 0 20px 0">We hope that these changes will allow for better match-making through ReDI Connect. And please let us know if you feel we missed any major mentoring subject.</mj-text>
...
<mj-text mj-class="text" padding="0 0 0 0">Paulina</mj-text>
