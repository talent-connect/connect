...
import { MentoringSessionsActionType, MentoringSessionsClearAsyncResultAction, MentoringSessionsCreateErrorAction, MentoringSessionsCreateStartAction, MentoringSessionsCreateSuccessAction, MentoringSessionsFetchErrorAction, MentoringSessionsFetchStartAction, MentoringSessionsFetchSuccessAction } from './types';
...
export const mentoringSessionsFetchError = (error: Error): MentoringSessionsFetchErrorAction => ({
