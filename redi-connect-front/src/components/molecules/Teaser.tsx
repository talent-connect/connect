    ...
    return (
      <>
        ...
        “Hi, I am <strong>Isabelle</strong>, the mentorship coordinator of ReDI Connect Berlin.
          {userType === 'public-sign-up-mentor-pending-review' && <> I take the time to meet each mentor before they join our program."</>}
          {userType === 'public-sign-up-mentee-pending-review' && <> I take the time to go through your application before you join our program."</>}
        </Element>
