...
6. If you're re-seeding, drop the database files: `rm -rf mongodb-data/*` and run `yarn seed` to seed the database.
   Alternatively, you can drop the database in the MongoDB Shell:
