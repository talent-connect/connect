...
<mj-text mj-class="text" padding="0 0 20px 0">Dear ReDI mentors,</mj-text>
...
<mj-text mj-class="text" padding="0 0 20px 0"><a href="https://redischool.typeform.com/to/G1I9Cdvr">Click here to fill in this survey</a>.</mj-text>
...
<mj-text mj-class="text" padding="0 0 20px 0">Thank you for being a ReDI mentor, without you the platform and program would not be possible!</mj-text>
