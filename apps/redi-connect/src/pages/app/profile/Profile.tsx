...
function Profile({
  ...
  const hasOpenApplication = profile && profile.numberOfPendingApplicationWithCurrentUser > 0;
  ...
  return (
    <LoggedIn>
      {hasOpenApplication && (
        <Notification>
          Awesome, your application has been sent. If you want to read it later on you can find it
