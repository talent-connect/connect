          ...
          <Columns>
            ...
            <Columns.Column desktop={{ size: 9, offset: 1 }} className="column--main-content">
              ...
              {profile.userType === 'public-sign-up-mentee-pending-review' && (
                <AccountNotReDI>
                  <strong>Thanks for signing up!</strong> We are reviewing your profile and will
                  send you an email once we're done. You'll be able to find a mentor once your
                  account is active.
                </AccountNotReDI>
              )}
              {profile.userType === 'public-sign-up-mentor-pending-review' && (
                <AccountNotReDI>
                  <strong>Thanks for signing up!</strong> We are reviewing your profile and will
                  send you an email once we're done. Students will be able to apply to become your
                  mentee once your account is active.
                </AccountNotReDI>
              )}
              {match && isNewMatch && (
                <Modal show={isNewMatch} confirm title="You’ve got a mentor match!">
                  <Modal.Body>
                    <Content>
                      ...
                      accepted your application. Here are already a few welcome words from your new
                      mentor.
                    </Content>
                    <Content italic>"{match.mentorReplyMessageOnAccept}"</Content>
                  </Modal.Body>
                  <Modal.Foot>
