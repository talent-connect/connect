...
export const useAcceptMentorshipMutation = <
    ...
    useMutation<AcceptMentorshipMutation, TError, AcceptMentorshipMutationVariables, TContext>(
      ['acceptMentorship'],
      (variables?: AcceptMentorshipMutationVariables) => fetcherForTp<AcceptMentorshipMutation, AcceptMentorshipMutationVariables>(AcceptMentorshipDocument, variables)(),
      options
    ););