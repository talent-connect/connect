...
export const useDeclineMentorshipMutation = <
    ...
    useMutation<DeclineMentorshipMutation, TError, DeclineMentorshipMutationVariables, TContext>(
      ['declineMentorship'],
      (variables?: DeclineMentorshipMutationVariables) => fetcherForTp<DeclineMentorshipMutation, DeclineMentorshipMutationVariables>(DeclineMentorshipDocument, variables)(),
      options
    ););