...
export const useTpJobseekerProfileExperienceRecordCreateMutation = <
    ...
    useMutation<TpJobseekerProfileExperienceRecordCreateMutation, TError, TpJobseekerProfileExperienceRecordCreateMutationVariables, TContext>(
      ['tpJobseekerProfileExperienceRecordCreate'],
      (variables?: TpJobseekerProfileExperienceRecordCreateMutationVariables) => fetcher<TpJobseekerProfileExperienceRecordCreateMutation, TpJobseekerProfileExperienceRecordCreateMutationVariables>(TpJobseekerProfileExperienceRecordCreateDocument, variables)(),
      options
    );