...
export enum RediCourse {
  ...
  NRW_SOCIAL_MEDIA_MARKETING = 'NRW_SOCIAL_MEDIA_MARKETING',
  ...
  MUNICH_FRONT_END_DEVELOPMENT_FULLTIME_ENG = 'MUNICH_FRONT_END_DEVELOPMENT_FULLTIME_ENG',
  MUNICH_FRONT_END_DEVELOPMENT_FULLTIME_GER = 'MUNICH_FRONT_END_DEVELOPMENT_FULLTIME_GER',
