...
export enum RediCourse {
  BERLIN_CYBERSECURITY = 'BERLIN_CYBERSECURITY',
  BERLIN_DATA_CIRCLE = 'BERLIN_DATA_CIRCLE',
  BERLIN_PROGRAMMING_WITH_JAVA = 'BERLIN_PROGRAMMING_WITH_JAVA',
  ...
  BERLIN_UX_UI_BASICS = 'BERLIN_UX_UI_BASICS',
  BERLIN_UX_UI_INTERMEDIATE = 'BERLIN_UX_UI_INTERMEDIATE',
  ...
  MUNICH_UX_UI_DESIGN = 'MUNICH_UX_UI_DESIGN',
  ...
  HAMBURG_INTRO_TO_CS = 'HAMBURG_INTRO_TO_CS',
  HAMBURG_HTML_CSS = 'HAMBURG_HTML_CSS',
  HAMBURG_UX_UI_DESIGN_BASIS = 'HAMBURG_UX_UI_DESIGN_BASIS',
  HAMBURG_INTERNET_OF_THINGS = 'HAMBURG_INTERNET_OF_THINGS',
